    ...
    func setupData(){
        sections = [
            Section(title: "Dynamic",
                    menu: [
                        Menu(title: "Default Dynamic Table", identifier: "DefaultDynamicViewController"),
                        Menu(title: "Custom Dynamic Table", identifier: "TableViewViewController"),
                        Menu(title: "Movie Enum Table", identifier: "MovieViewController"),
                        Menu(title: "Class Table", identifier: "ClassViewController"),
                        ]),
            Section(title: "Dynamic 2",
                    menu: [
                ])
        ]
    }
